 ...
 * Licence LGPLv3 Publish 2012-10-03
 *
 * @author Deisss
 * @version 0.1
 */
public class ClassPath {
    ...
    private String webInfPath, webXmlPath, configXmlPath, webRootPath;
    ...
    private ClassPath() {
        ...
        this.webRootPath = this.getWebInfPath().substring(0, this.getWebInfPath().indexOf("WEB-INF"));
    }
